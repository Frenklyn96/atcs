...
var POIs = [{"id":44, "x":68, "y":94, "name":"CarpenterTools"},{"id":21,"x":68, "y":143, "name":"Pottery"},{"id":46,"x":68, "y":176, "name":"MaritimeArcheology"},{"id":33,"x":155, "y":116, "name":"ShipBack"},
    ...
    {"id":40,"x":439, "y":283, "name":"JewishCoffins"},{"id":34,"x":323, "y":330, "name":"BuildingMethodsAndFacilities"},{"id":65,"x":334, "y":300, "name":"ReligionAndCult"},{"id":38,"x":361, "y":327, "name":"CraftsAndArts"},
...
svg.append("image")
    ...
    .attr("width", "80%")
    .attr("height", "80%")
    .attr("xlink:href", "http://localhost:8080/media/HechtMuseumNew_edited.png");
...
function moveVisitor(data, count) {
    ...
    svg.select("circle.visitor")
        .transition()
        .duration(1500) // <--- reduce the duration when count is high
        .delay(data[0].time*10)
